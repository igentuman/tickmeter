...
namespace tickMeter.GameManagers
{
    class PubgStatsManager
    {
        ...
        public void ProcessPacket(Packet packet, GUI gui)
        {
            ...
            if (packet.Ethernet.IpV4.Udp.SourcePort > StartPort && packet.Ethernet.IpV4.Udp.SourcePort < EndPort && openPorts.Contains(packet.Ethernet.IpV4.Udp.DestinationPort) )
            {
            ...
            if (packet.Ethernet.IpV4.Udp.DestinationPort > StartPort && packet.Ethernet.IpV4.Udp.DestinationPort < EndPort && openPorts.Contains(packet.Ethernet.IpV4.Udp.SourcePort))
            {
                NetworkActivityFlag = true;
